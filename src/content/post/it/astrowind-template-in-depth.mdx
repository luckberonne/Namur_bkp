...
title: Approfondimento sul template Namur
excerpt: Sebbene sia facile iniziare, Namurè abbastanza complesso internamente. Questa pagina fornisce la documentazione su alcune delle parti più intricate.
...
tags:
  ...
  - front-end
metadata:
  canonical: https://namur.vercel.app/es/namur-template-in-depth
---
...
<CallToAction
  callToAction={{
    ...
    href: 'https://github.com/onwidget/namur',
