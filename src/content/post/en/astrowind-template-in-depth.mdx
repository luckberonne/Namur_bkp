...
title: Namurtemplate in depth
excerpt: While easy to get started, Namur is quite complex internally.  This page provides documentation on some of the more intricate parts.
...
tags:
  ...
  - front-end
metadata:
  canonical: https://namur.vercel.app/namur-template-in-depth
---
